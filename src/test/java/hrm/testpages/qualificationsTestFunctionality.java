...
public class qualificationsTestFunctionality extends baseclass{
	...
	public void Validate_qualification_Sendkeys() throws InterruptedException {
		...
		QualificationFunctionality.Validate_description(prop.getProperty("des"));
		Assert.assertEquals(QualificationFunctionality.Validate_cancel_Text(), "Cancel");
	}
	@AfterMethod
